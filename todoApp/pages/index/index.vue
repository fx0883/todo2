<template>
	<view class="container">
		<!-- 分类筛选 -->
		<scroll-view class="categories" scroll-x show-scrollbar="false" enhanced>
			<view class="category-list">
				<view class="category-item" :class="{ active: !selectedCategory }" @click="selectedCategory = null">
					全部
				</view>
		...
		<!-- 任务列表区域 -->
		<scroll-view class="task-list-container" scroll-y refresher-enabled :refresher-triggered="refreshing"
